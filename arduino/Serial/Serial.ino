...
void setup()
{
  Serial.begin(9600);
  Wire.begin();
  compass.init(LSM303::device_auto, LSM303::sa0_low); //SDO do GND
 compass2.init(LSM303::device_auto, LSM303::sa0_high);
...
void loop()
{
  ...
  snprintf(report2, sizeof(report2), "A2: %6d %6d %6d ",
    compass2.a.x, compass2.a.y, compass2.a.z);
